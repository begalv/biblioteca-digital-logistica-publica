...
/*Uso da Tag  crossorigin='anonymous' para corregir o erro ERR_BLOCKED_BY_RESPONSE.NotSameOrigin*/
 ...
 $i =0;
  ...
  while($row = pg_fetch_array($q)){
	/*echo "<tr>";  */
	if ($row['code'] <> '') {
		//$flag = "<img crossorigin='anonymous' src='https://countryflagsapi.com/png/".strtolower($row['code'])."' width='30px' height='20px' alt='Bandeira:".$paises[$row['code']]."' > ". $paises[$row['code']]; 
